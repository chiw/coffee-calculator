                        ...
                        {#each getMenu().brandMenus as brandMenu, brandIndex}
                            <ul class="pl-4">                                     
                                {#each brandMenu.dripperMenus as dripperMenu, dripperIndex}
                                    <li class="my-2">
                                        <button 
                                            onclick={() => toggleBrandDripper(dripperMenu.brandName, dripperMenu.dripperName)}
                                            class="flex items-center justify-between w-full font-bold py-1 hover:bg-gray-50"
                                        >
                                            <span>{brandMessageKey(brandMenu.dripperMenus[0].brandName)()} {dripperMessageKey(dripperMenu.dripperName)()}</span>
                                            <svg 
                                                class="w-4 h-4 transition-transform duration-200"
                                                class:rotate-180={isBrandDripperExpanded(dripperMenu.brandName, dripperMenu.dripperName)}
                                                viewBox="0 0 20 20"
                                                fill="currentColor"
                                            >
