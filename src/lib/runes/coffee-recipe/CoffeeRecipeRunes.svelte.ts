...
import {
	createCoffeeRecipe,
	createCoffeeRecipeStepsWithChangeFactors
} from '$lib/coffee-recipes/CoffeeRecipesFactory';
import type {
	CoffeeRecipe,
	CoffeeRecipeSteps,
	RecipeChangeFactors
} from '$lib/coffee-recipes/CoffeeRecipeTypes';
...
export function createCoffeeRecipeRunes(defaultCoffeeRecipeId: CoffeeRecipeId) {
	...
	return {
		...
		get coffeeRecipe() {
			return _coffeeRecipe;
		},
		get coffeeRecipeSteps() {
			return _coffeeRecipeSteps;
		},

		get recipeChangeFactors() {
			return _recipeChangeFactors;
		},
		set recipeChangeFactors(value) {
			_recipeChangeFactors = value;
		}
	};
}
...
export const setCoffeeRecipeRunes = () => {
	return setContext(
		COFFEE_RECIPE_RUNES_CONTEXT_KEY,
		createCoffeeRecipeRunes(CoffeeRecipeId.hario_switch_tetsukasuyanewhybrid)
	);
};
