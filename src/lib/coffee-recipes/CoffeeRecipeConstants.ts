...
} from './menu/CoffeeRecipeMenuUtils';

import {
	createSearchParams,
	filterMetaInfosBySearchParams,
	getPathFromMetaInfo,
	isRecipeMetaInfo
} from './MetaInfoUtils';
	...
	<DripperBrand>{
		...
		drippers: [
			<DripperType>{
				...
				recipes: [
					<DripperRecipe>{
						recipeId: CoffeeRecipeId.hario_switch_tetsukasuyanewhybrid,
						name: 'tetsukasuyanewhybrid',
						createdBy: 'tetsukasuya'
					},
					<DripperRecipe>{
						recipeId: CoffeeRecipeId.hario_switch_tetsukasuya,
						name: 'tetsukasuya',
						createdBy: 'tetsukasuya'
					},
					<DripperRecipe>{
						recipeId: CoffeeRecipeId.hario_switch_emifukahori,
						name: 'emifukahori',
						createdBy: 'emifukahori'
					},
					<DripperRecipe>{
						recipeId: CoffeeRecipeId.hario_switch_olekristianboen,
						name: 'olekristianboen',
						createdBy: 'olekristianboen'
					},
					<DripperRecipe>{
						recipeId: CoffeeRecipeId.hario_switch_coffeechronicler,
						name: 'coffeechronicler',
						createdBy: 'coffeechronicler'
					},
					<DripperRecipe>{
						recipeId: CoffeeRecipeId.hario_switch_cafetaster,
						name: 'cafetaster',
						createdBy: 'cafetaster'
					}
				]
			},
			<DripperType>{
				...
				recipes: [
					<DripperRecipe>{
						recipeId: CoffeeRecipeId.hario_v60_46method,
						name: '46method',
						createdBy: 'tetsukasuya'
					},
					<DripperRecipe>{
						recipeId: CoffeeRecipeId.hario_v60_jameshoffmann,
						name: 'jameshoffmann',
						createdBy: 'jameshoffmann'
					},
					<DripperRecipe>{
						recipeId: CoffeeRecipeId.hario_v60_mattwinton,
						name: 'mattwinton',
						createdBy: 'mattwinton'
					}
				]
			}
		]
	...
	<DripperBrand>{
		...
		drippers: [
			<DripperType>{
				...
				recipes: [
					<DripperRecipe>{
						recipeId: CoffeeRecipeId.kalita_wave155_itoatsuomi,
						name: 'itoatsuomi',
						createdBy: 'itoatsuomi'
					}
				]
			}
		]
			...
			return <CoffeeRecipeConfig>{
				...
				stepAdjustments: {
					...
					twoStepsRatios: {
						...
						options: [
							{
								name: 'newHybridSweeter',
								default: true,
								waterPercentageRatios: [13.3333, 26.6667]
							},
							{ name: 'newHybridBalanced', default: true, useDefault: true },
							{
								name: 'newHybridBrighter',
								default: false,
								waterPercentageRatios: [16.6667, 23.3333]
							}
						]
					},
					pourDivisions: {
						...
						options: [{ name: 'newHybridTwoPours', default: true, useDefault: true }]
					}
				},
				steps: [
					{
				...
				references: [
					{
						description:
							'The Ultimate Recipe for Brewing Any Coffee Bean Deliciously Has Evolved Even Further! - Tetsu Kasuya',
			...
			return <CoffeeRecipeConfig>{
				...
				steps: [
					...
					},
					{
						...
						durationInSeconds: 30,
						pourParameters: { waterPercentage: 57.143, waterTemp: '70' }
					},
					{
						switchState: SwitchState.OPEN,
						stage: PourOverStage.FINAL,
				...
				references: [
					{
						description:
							'Is it the God Recipe, or the Devil Recipe? ｜ The Ultimate Switch Recipe Ever!! - Tetsu Kasuya',
		...
		case CoffeeRecipeId.hario_switch_coffeechronicler: {
			return <CoffeeRecipeConfig>{
				...
				stepAdjustments: {
					...
					selectedOptions: [
						{
							stepAdjustmentName: StepAdjustment.POUR_DIVISIONS,
							option: 'coffeeChroniclerStandardVersion'
						}
					],
					pourDivisions: {
						canEdit: true,
						...
						options: [
							...
							{
								name: 'coffeeChroniclerSweetVersion',
								default: false,
								steps: [
									{
										switchState: SwitchState.OPEN,
			...
			return <CoffeeRecipeConfig>{
				...
				stepAdjustments: {
					...
					twoStepsRatios: {
						...
						options: [
							{
								name: 'method46Sweeter',
								default: false,
								waterPercentageRatios: [16.6667, 23.3333]
							},
							{ name: 'method46Standard', default: true, useDefault: true },
							{
								name: 'method46Brighter',
								default: false,
								waterPercentageRatios: [23.3333, 16.6667]
							}
						]
					},
					pourDivisions: {
						...
						totalPercentages: 60,
						stepsStages: [
							PourOverStage.THIRD_POUR,
							PourOverStage.FOURTH_POUR,
							PourOverStage.FIFTH_POUR
						],
						selectMode: 'OPTIONS',
						defaultSteps: [
							{
