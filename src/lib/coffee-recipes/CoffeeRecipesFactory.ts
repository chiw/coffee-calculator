...
export const createCoffeeRecipeStepsWithChangeFactors = (
	...
	let clonedRecipeChangeFactors: RecipeChangeFactors = <RecipeChangeFactors>(
	...
	let stepWaterInfos: StepWaterInfo[] = calculateStepWaterInfos(
		clonedRecipeChangeFactors.coffeeParameters,
		pourParameters
	);

	let stepsWithTimeframeAndWaterInfo: StepConfig[] = stepsWithTimeframe.map((step, index) => {
